        ...
        <div class="section__content container">
            <div class="col-12 text-center">
                ...
                <div class="cta-button">
                    <button type="button" class="btn btn-cust-white mb-3" data-bs-toggle="modal" data-bs-target="#rulesModal">Lihat Aturan Main</button>
            ...
            <div class="col-12">
                <div class="gallery mt-5">
                    <div class="gallery-container">
                        ...
                        <img class="gallery-item" style="cursor: pointer" data-id="{{ $category->id }}" src="{{ asset('category/' . $category->thumbnail) }}">
                        @endforeach
                    </div>
