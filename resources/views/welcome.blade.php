    ...
    <section class="section section__home1" id="scrollspySection1">
        <div class="section__content container">
            <div class="col-12 text-center">
                ...
                <button type="button" class="btn btn-cust-yellow" data-bs-toggle="modal" data-bs-target="#rulesModal">Lihat Aturan Main</button>
            </div>
        </div>
    </section>
        ...
        <div class="modal-content gt-modal-content">
            ...
            <div class="modal-body gt-modal-body">
                ...
                <ol class="lh-lg mb-4">
                    ...
                    <li>Tambahkan kreasimu dengan menuliskan kata-kata mutiara atau upload photo/gambar yang kamu inginkan.</li>
