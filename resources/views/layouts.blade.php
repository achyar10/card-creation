...
<head>
    ...
    <link href="{{ asset('frontend/styles/style.css?v=1.0.21') }}" rel="stylesheet">
            ...
            <div class="modal-content gt-modal-content">
                ...
                <div class="modal-body gt-modal-body">
                    <div class="gt-video text-center">
                        <iframe width="100%" height="300" src="https://www.youtube.com/embed/w34eb8F0_88"
                            srcdoc="<style>*{padding:0;margin:0;overflow:hidden}html,body{height:100%}img,span{position:absolute;width:100%;top:0;bottom:0;margin:auto}span{height:1.5em;text-align:center;font:48px/1.5 sans-serif;color:white;text-shadow:0 0 0.5em black}</style><a href=https://www.youtube.com/embed/w34eb8F0_88?autoplay=1><img src=https://img.youtube.com/vi/w34eb8F0_88/hqdefault.jpg alt='Cara Ikutan GoodTime Gift Card'><span>▶</span></a>"
                            title="Cara Ikutan GoodTime Gift Card"
                            frameborder="0"
